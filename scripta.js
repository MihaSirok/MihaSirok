function drawIt() {
	...
	plosca.src="Slike/ploscek.png";
	var opeka=new Image();
	opeka.src="Slike/Opeka2.png";
	var uprasaj=new Image();
	uprasaj.src="Slike/Uprasaj2.png";
	var prazen=new Image();
	prazen.src="Slike/PrazenUprasaj.png";
	var goban=new Image();
	goban.src="Slike/goba.png";
	var smash=new Audio('Zvok/smash.wav');
	var pada=new Audio("Zvok/PowerUp.wav");
	var hrana=new Audio("Zvok/Hrana.wav");
	var jump=new Audio("Zvok/jump.wav");
	var bump=new Audio("Zvok/bump.wav");
	var victory=new Audio("Zvok/Zmaga.wav");
	var lose=new Audio("Zvok/Zguba.wav");
	var bricks;
	var NROWS;
	var NCOLS;
	var BRICKWIDTH;
